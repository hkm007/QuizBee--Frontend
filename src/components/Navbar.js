      ...
      <Navbar dark expand="md" style={{backgroundColor:'#6b00b3'}}>
        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className="mr-auto" navbar>
            ...
            <Link to="/blogs" ref={item => inputRef.current[1] = item} className="my-2" style={{textDecoration:'None', color:'white', marginRight:'10px'}} onMouseEnter={()=>changeColor1(1)} onMouseLeave={()=>changeColor2(1)}><b>Test</b></Link>
